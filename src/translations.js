export const t = {
  ...
  number_of_columns: {
    ...
    de: 'Number of columns',
    it: 'Numero di colonnine',
    nl: 'Number of columns',
    cs: 'Number of columns',
    pl: 'Number of columns',
    fr: 'Number of columns',
    ru: 'Number of columns'
  },
  type_of_plugs: {
    en: 'Type of plugs',
    de: 'Type of plugs',
  ...
  current_number_of_columns: {
    ...
    nl: 'Current number of columns',
    cs: 'Current number of columns',
    pl: 'Current number of columns',
    fr: 'Current number of columns',
